...
import { Users, Maximize, Wifi, Tv, Coffee, Bath } from 'lucide-react';
    ...
    <section id="rooms" className="py-16 md:py-24 bg-muted/30">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <p className="text-sm uppercase tracking-widest text-muted-foreground mb-2">Accommodations</p>
          <h2 className="font-serif text-3xl md:text-4xl font-bold text-foreground mb-4">
            Our Rooms & Suites
          </h2>
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Choose from our selection of elegantly designed rooms, each offering comfort, style, and modern amenities for an unforgettable stay.
          </p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {roomTypes.map((room) => (
            <Card key={room.id} className="group overflow-hidden hover:shadow-lg transition-shadow">
              ...
              <CardContent className="p-6">
                ...
                <Button 
                  ...
                  onClick={() => navigate(`/booking?roomType=${room.id}`)}
                >
